export const jsonData={
  ...
  "blocks": [
    ...
    {
      "type": "flashcard",
      "front": "A 65-year-old presents with tense blisters on the trunk and limbs. Nikolsky sign is negative. What is the most likely diagnosis?",
      "back": "Bullous Pemphigoid — tense, subepidermal blisters in elderly patients with a negative Nikolsky sign. Antibodies target BP180/BP230 at the dermal-epidermal junction.",
      "tags": ["dermatology", "autoimmune"]
    }
  ]
}